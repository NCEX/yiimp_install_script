...
################################################################################
    ...
    sudo apt -y install dialog python3 python3-pip acl nano apt-transport-https software-properties-common
    ...
    # Compil Blocknotify
    cd ~
    git clone https://github.com/NCEX/yiimp
    ...
    cd $HOME/yiimp
    sudo sed -i 's/myadmin/'PoolPortal'/' $HOME/yiimp/web/yaamp/modules/site/SiteController.php
    ...
    echo -e "$RED Line 11 => change 'DirtyPanel' and use the new address"
    echo
    ...
    echo -e "$CYAN Easy Client WebSite : https://easy-client-co.ltd $COL_RESET"
    echo
    echo
